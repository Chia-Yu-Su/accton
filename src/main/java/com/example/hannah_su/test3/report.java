...
public class report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url="https://accmis-t.accton.com.tw/system_mobile?id_app_device="+id_app_device+"&to=report";
        ...
        home.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                intent.setClass(report.this,menu.class);
        ...
        personal.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(report.this,personal.class);
                intent.putExtra("id_app_device",id_app_device);
                intent.putExtra("username",username);
                intent.putExtra("userlogon",userlogon);
                //intent.putExtra("domain",domain);
        ...
        setting.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(report.this,setting.class);
                intent.putExtra("id_app_device",id_app_device);
                intent.putExtra("username",username);
                intent.putExtra("userlogon",userlogon);
                //intent.putExtra("domain",domain);
